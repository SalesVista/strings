...
tap.test('toPlural', t => {
  ...
  t.strictEqual(Strings.toPlural('BOX'), 'BOXES')
  t.strictEqual(Strings.toPlural('plan', 'en-US'), 'plans')
  t.strictEqual(Strings.toPlural('plan', 'en_US'), 'plans')
  t.strictEqual(Strings.toPlural('plan', 'invalid locale'), 'plans')
  t.strictEqual(Strings.toPlural('PLAN', 'en-US'), 'PLANS')
  t.strictEqual(Strings.toPlural('PLAN', 'en_US'), 'PLANS')
  t.strictEqual(Strings.toPlural('PLAN', 'invalid locale'), 'PLANS')
  t.end()
